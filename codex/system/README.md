...
- **What:** `codex/system` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **system** subsystem.
- **Why:** This folder exists to isolate `system` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/system` (within the core Codex runtime tree).
