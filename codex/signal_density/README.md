...
- **What:** `codex/signal_density` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **signal_density** subsystem.
- **Why:** This folder exists to isolate `signal_density` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/signal_density` (within the core Codex runtime tree).
