...
- **What:** `codex/telemetry` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **telemetry** subsystem.
- **Why:** This folder exists to isolate `telemetry` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/telemetry` (within the core Codex runtime tree).
