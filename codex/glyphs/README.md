...
- **What:** `codex/glyphs` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **glyphs** subsystem.
- **Why:** This folder exists to isolate `glyphs` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/glyphs` (within the core Codex runtime tree).
