...
- **What:** `codex/quantum_tunneling` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **quantum_tunneling** subsystem.
- **Why:** This folder exists to isolate `quantum_tunneling` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/quantum_tunneling` (within the core Codex runtime tree).
