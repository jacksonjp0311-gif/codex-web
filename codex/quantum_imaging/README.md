...
Synthetic AFM simulations here demonstrate a similar stability signature:
C/H₇ ≈ 0.75–0.78
...
• JSON state metrics including:
    E_mean, I_entropy, ΔΦ_mean, C_codex, C/H₇
...
1) Direct Python:
    python codex/quantum_imaging/codex_quantum_imaging_v1_0.py
