...
- **What:** `codex/primes` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **primes** subsystem.
- **Why:** This folder exists to isolate `primes` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/primes` (within the core Codex runtime tree).
