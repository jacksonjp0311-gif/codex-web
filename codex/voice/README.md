...
- **What:** `codex/voice` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **voice** subsystem.
- **Why:** This folder exists to isolate `voice` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/voice` (within the core Codex runtime tree).

## Mini directory

### Files

- `codex_voice_amplifier_v1_7.ps1`
- `codex_voice_amplifier_v1_8.ps1`
