...
- **What:** `codex/v2` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **v2** subsystem.
- **Why:** This folder exists to isolate `v2` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/v2` (within the core Codex runtime tree).
