...
- **What:** `codex/observability` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **observability** subsystem.
- **Why:** This folder exists to isolate `observability` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/observability` (within the core Codex runtime tree).
