# Codex Bio-Resonance Engine v1.1 — Living Resonance
...
- \state/v1_1/bio_resonance_state_v1_1.json\
- \isuals/v1_1/bio_resonance_spine_profile_v1_1.png\
- \isuals/v1_1/bio_resonance_delta_phi_heatmap_v1_1.png\
- \isuals/v1_1/bio_resonance_coherence_wavefield_v1_1.png\
- \isuals/v1_1/bio_resonance_lotus_field_v1_1.png\
- \isuals/v1_1/bio_resonance_torus_field_v1_1.png\
- \glyph/bio_resonance_glyph_v1_1.json\
- \logs/ledger/bio_resonance_ledger.jsonl\
- \ackend/bio_resonance_request_v1_1.json\
- \ackend/bio_resonance_response_v1_1.json\ (optional, filled by GPT bridge / oracle)
...
- **Codex Resonant GPT Matrix v1.1**
