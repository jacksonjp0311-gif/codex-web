# Codex Third Eye Amplify v1.6 — Python Engine
import json, datetime, os
import numpy as np
import matplotlib.pyplot as plt

LOG_FILE   = "third_eye_resonance_log.jsonl"
PLOT_FILE  = os.path.join("..","visuals","third_eye_dual_2025-11-10_19-05-16.png")
STATE_FILE = os.path.join("..","state","third_eye_state_2025-11-10_19-05-16.json")
...
def render_dual(snap,window=32):
    ...
    ax1.set_title("Codex Third Eye Resonance v1.6")
    if Cs:
        ax2.plot(Cs,marker="o"); ax2.set_title("Coherence History")
        ax2.set_ylim(0,max(1.1,max(Cs)+0.05))
    plt.tight_layout(); plt.savefig(PLOT_FILE,dpi=180); plt.close()
