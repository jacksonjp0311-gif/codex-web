...
- **What:** `codex/data` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **data** subsystem.
- **Why:** This folder exists to isolate `data` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/data` (within the core Codex runtime tree).
