...
- **What:** `codex/visuals` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **visuals** subsystem.
- **Why:** This folder exists to isolate `visuals` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/visuals` (within the core Codex runtime tree).
