...
- **What:** `codex/quantum.crystal` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **quantum.crystal** subsystem.
- **Why:** This folder exists to isolate `quantum.crystal` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/quantum.crystal` (within the core Codex runtime tree).
