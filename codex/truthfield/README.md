...
- **What:** `codex/truthfield` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **truthfield** subsystem.
- **Why:** This folder exists to isolate `truthfield` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/truthfield` (within the core Codex runtime tree).
