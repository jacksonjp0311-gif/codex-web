...
- **What:** `codex/align_pulse` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **align_pulse** subsystem.
- **Why:** This folder exists to isolate `align_pulse` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/align_pulse` (within the core Codex runtime tree).

## Mini directory

### Files

- `align_pulse_log.ndjson`
- `align_pulse_state.json`
