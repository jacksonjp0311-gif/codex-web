...
- **What:** `codex/quantum` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **quantum** subsystem.
- **Why:** This folder exists to isolate `quantum` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/quantum` (within the core Codex runtime tree).
