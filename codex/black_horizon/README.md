...
- **What:** `codex/black_horizon` is a Codex runtime domain folder that stores module logic, state, logs, or related artifacts for the **black_horizon** subsystem.
- **Why:** This folder exists to isolate `black_horizon` responsibilities, reduce coupling with other domains, and make evolution/versioning safer over time.
...
- **Where:** Path: `codex/black_horizon` (within the core Codex runtime tree).
